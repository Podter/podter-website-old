...
![Final result](@/assets/content/pwsh-customization/final.png)
...
![Windows Terminal profile](@/assets/content/pwsh-customization/wt-font.png)
...
![Modified montys theme](@/assets/content/pwsh-customization/oh-my-posh-theme.png)
...
![lsd tree](@/assets/content/pwsh-customization/lsd.png)
...
![Autocompletion](@/assets/content/pwsh-customization/autocompletion.png)
...
![Terminal Operating System GIF](@/assets/content/pwsh-customization/terminal.gif)
