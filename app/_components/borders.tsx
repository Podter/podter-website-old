export default function Borders() {
  return (
    <div className="pointer-events-none absolute left-0 right-0 top-0 -z-10 h-full min-h-screen w-full select-none bg-opacity-50">
      ...
      <div className="absolute right-4 top-0 h-full w-px bg-border"></div>
    </div>
  );
}
