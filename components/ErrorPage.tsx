  ...
  return (
    <>
      <div className="relative flex flex-col text-center justify-center items-center w-full h-[calc(100vh-10.5rem)] md:h-[calc(100vh-18rem)]">
        ...
        <div className="hidden lg:block -top-[12.5%] -left-[12.5%] absolute w-[125%] h-[125%] overflow-hidden -z-30">
          <div className="relative w-full h-full">
            <FlyingToasters className="absolute top-0 left-0 w-full h-full -z-20" />
            <div className="absolute top-0 left-0 w-full h-full -z-10 shadow-[inset_0px_0px_50px_125px_hsl(var(--background))]"></div>
          </div>
        </div>
      </div>
      <FlyingToasters className="fixed lg:hidden top-0 left-0 w-full h-screen -z-30" />
    </>
  );
}
